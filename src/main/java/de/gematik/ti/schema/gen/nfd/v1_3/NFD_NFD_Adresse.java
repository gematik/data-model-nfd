...
public class NFD_NFD_Adresse  {
    ...
    // copy Constructor
    public NFD_NFD_Adresse(NFD_NFD_Adresse _NFD_NFD_Adresse) {
        
        this.Adresse = _NFD_NFD_Adresse.Adresse;
    }
    
    public static NFD_NFD_Adresse deserialize(Node node) {
        if (node == null) {
            return null;
        }
        Element element = (Element) node;
        
        NFD_NFD_Adresse _NFD_NFD_Adresse = new NFD_NFD_Adresse();
        ...
        _NFD_NFD_Adresse.Adresse = NFDM_Adresse.deserialize(nodeAdresse);
        
        return _NFD_NFD_Adresse;
    }
    
    public static List deserializeToList(List<Node> nodeList) {
        List result = new ArrayList<NFD_NFD_Adresse>();
